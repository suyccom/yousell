...
feature 'The admin wants to manage product_types', :driver => :selenium do
  ...
  scenario 'Admin adds and edits (no conditions to edit by now) product_types' do
    ...
    page.find('tr.product_type:nth-child(1) .this-view').should have_content 'Barra de pan'
    ...
    page.find('tr.product_type:nth-child(1) .this-view').should have_content 'Barra'
    ...
    page.find('tr.product_type:nth-child(2) .this-view').should have_content 'Pan de pueblo'
