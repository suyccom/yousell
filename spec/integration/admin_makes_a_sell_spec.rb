...
feature 'The admin wants to make a sell', :driver => :selenium do
  ...
  before do
    ...
    pt.variations << color
    pt.save
    black_shoes = Product.new(:price => 15, :amount => 10, :barcode => '11BLACK')
    ...
    black_shoes.save
    white_shoes = Product.new(:price => 16, :amount => 10, :barcode => '11WHITE')
  ...
  scenario 'Admin makes a sell' do
    ...
    click_on '+'
    page.should have_content "Sorry, the line was not added because the barcode '11GREEN' was not found"
    
    click_on 'Sell'
    page.should have_content 'The sell has been made successfully'
  end
